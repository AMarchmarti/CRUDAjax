$(document).ready(function() {
        ...
        $.getJSON("http://localhost/dev/SimpleRestApi/api/product/update.php?id=" + id, function(data) {
            ...
            $.getJSON("http://localhost/dev/SimpleRestApiPHP/api/category/read.php", function(data) {
                ...
                $.each(data.records, function(key, val) {
                    ...
                    if (val.id == category_id) { categories_options_html += `<option value='` + val.id + `' selected>` + val.name + `</option>`; } else { categories_options_html += `<option value='` + val.id + `'>` + val.name + `</option>`; }
                });
    ...
    $(document).on('submit', '#update-product-form', function() {
        ...
        $.ajax({
            url: "http://localhost/dev/SimpleRestApiPHP/api/product/update.php",
            type: "POST",
